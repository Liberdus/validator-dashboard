...
```bash
curl -O https://raw.githubusercontent.com/liberdus/validator-dashboard/dev/installer.sh && chmod +x installer.sh && sudo ./installer.sh
```

Using `wget`

```bash
wget https://raw.githubusercontent.com/liberdus/validator-dashboard/dev/installer.sh && chmod +x installer.sh && sudo ./installer.sh
```
