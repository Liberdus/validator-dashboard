...
git clone -b liberdus-api-data https://github.com/liberdus/validator-cli.git cli
...
git clone -b stake-via-web-client https://github.com/liberdus/validator-gui.git gui
